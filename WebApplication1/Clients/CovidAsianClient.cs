...
{
    public class CovidAsianClient
    {
        private HttpClient _client2;
        private static string _address;
        private static string _apiKey;
        public CovidAsianClient()
        {
        ...
        public async Task<List<CovidAsian>> GetCovidAsian()
        {
            ...
            HttpRequestMessage request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/asia"),
                Headers =
                {
            ...
            var result = JsonConvert.DeserializeObject<List<CovidAsian>>(content);
            return result;
        }
    }
}
