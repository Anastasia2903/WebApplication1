...
{
    public class CovidAfricanClient
    {
        private HttpClient _client3;
        private static string _address;
        private static string _apiKey;

        public CovidAfricanClient()
        {
        ...
        public async Task<List<CovidAfrica>> GetCovidAfrica()
        {
            ...
            HttpRequestMessage request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri($"https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/africa"),
                Headers =
                {
            ...
            var result = JsonConvert.DeserializeObject<List<CovidAfrica>>(content);
            return result;
        }
